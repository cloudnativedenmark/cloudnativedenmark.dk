    ...
    <Layout>
      <div className="text-primary text-base font-sans mx-28 pb-12">
        ...
        <p className="mt-16">
          ...
          shared and/or collected in kcddenmark.dk. This policy is not
        ...
        <p>
          <pre className="inline">cloudnativedenmark.dk</pre> follows a standard
        ...
        <p>
          ...
          advertisements and links that appear on kcddenmark.dk, which are sent
        ...
        <p>
          Note that kcddenmark.dk has no access to or control over these cookies
        ...
        <p>
          <pre className="inline">cloudnativedenmark.dk</pre> does not knowingly
